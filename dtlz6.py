...
def plot_combined_metrics(history):
    ...
    plt.title('Convergence of Performance Metrics for DTLZ6 Problem', fontsize=16, fontweight='bold', pad=12)
    ...
    plt.tight_layout()
    plt.savefig('dtlz6convg.png', dpi=300, bbox_inches='tight')
    plt.show()
    plt.close()
    print("Saved: dtlz6convg.png successfully.")

def plot_pareto_front(true_pf, final_front):
    """3D Pareto Plot formatted for DTLZ6 curve alignment"""
...
if __name__ == "__main__":
    ...
    print("--- Starting 30-Run Optimization for DTLZ6 ---")
