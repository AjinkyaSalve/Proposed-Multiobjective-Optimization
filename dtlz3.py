...
def plot_combined_metrics(history):
    ...
    plt.title('Convergence of Performance Metrics for DTLZ3 Problem', fontsize=16, fontweight='bold', pad=12)
    ...
    plt.tight_layout()
    plt.savefig('dtlz3convg.png', dpi=300, bbox_inches='tight')
    plt.show()
    plt.close()
    print("Saved: dtlz3convg.png successfully.")
...
if __name__ == "__main__":
    ...
    for run in range(num_runs):
        ...
        # Track convergence on the final run for the plot
        if run == num_runs - 1:
