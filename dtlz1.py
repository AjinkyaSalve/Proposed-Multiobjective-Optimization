# -*- coding: utf-8 -*-
"""
Created on Wed Jun 24 13:27:57 2026
...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 27 15:04:34 2025
...
if __name__ == "__main__":
    ...
    for run in range(num_runs):
        ...
        # Metrics for this run's final archive
    ...
    # Generate the convergence plot averaged across all runs
    mean_history = plot_combined_metrics(all_histories)

    # --- 3D Pareto Front Visualization Styled for Continuous Overlap (final run's archive) ---
    ...
    # --- Summary Statistics Across All 30 Runs ---
