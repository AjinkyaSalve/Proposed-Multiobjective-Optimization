# -*- coding: utf-8 -*-
"""
Created on Wed Jun 24 13:56:44 2026
...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 29 17:22:55 2025
...
# --- Multi-Objective Rao Algorithm with Tracking ---
def multi_objective_rao_with_tracking(pop_size, num_variables, var_ranges, max_iterations, archive_size, objective_functions, true_pf, ref_point):
    ...
    # Initialize metrics tracking history
    metrics_history = {
        "fe": [], "GD": [], "IGD": [], "SP": [], "SD": [], "HV": []
    }
    ...
    for iteration in range(max_iterations):
        ...
        # Log performance metrics dynamically at current generation step
...
for run in range(num_runs):
    ...
    # Calculate final comprehensive metrics snapshot
...
# Plot True Pareto Front first (Blue sphere points in background layer)
ax.scatter(true_pf[:, 0], true_pf[:, 1], true_pf[:, 2], 
           color='blue', s=30, alpha=0.6, marker='o', label='True Pareto Front', zorder=1)

# Plot Obtained Pareto Front directly on top (Red solid sphere points overlaying perfectly)
...
# Orientation setup for true front matching and alignment
