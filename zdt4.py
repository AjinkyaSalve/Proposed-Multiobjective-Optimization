...
def multi_objective_rao(population_size, num_variables, variable_ranges, objective_functions, max_iterations, archive_size, true_pf, reference_point, minimization=True):
    ...
    # History logs for convergence tracking
    history_evals = []
    history_gd = []
    history_igd = []
    history_sp = []
    ...
    for iteration in range(max_iterations):
        ...
        # Update Archive with new generation
        for solution in new_population:
            archive = update_archive(archive, solution, archive_size, minimization)
        population = new_population
        
        # Calculate and log performance metrics at this evaluation check point
...
# ==================================================
# PLOT 1: True vs Obtained Pareto Front Validation
# ==================================================
...
# ==================================================
# PLOT 2: Convergence of Performance Metrics
# ==================================================
