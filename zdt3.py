# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 13:35:14 2026
...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 15 22:23:02 2025
...
def zdt3_f2(x):
    g = zdt3_g(x)
    return g * (1 - math.sqrt(zdt3_f1(x) / g) - (zdt3_f1(x) / g) * math.sin(10 * math.pi * zdt3_f1(x)))
...
objective_functions = [zdt3_f1, zdt3_f2]
population_size = 100
max_iterations = 400
archive_size = 100
num_runs = 30
reference_point = [0.85, 1] 
...
plt.title('Convergence of Performance Metrics for ZDT3 Problem', fontsize=16, fontweight='bold', pad=12)
...
plt.tight_layout()
plt.savefig('zdt3convg.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
...
plt.title('True vs. Obtained Pareto Front for ZDT3', fontsize=16, fontweight='bold', pad=12)
...
plt.grid(False)
plt.tight_layout()
plt.savefig('zdt3pf.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
print("Saved: Figure_Pareto_Front_Final.png successfully.")
