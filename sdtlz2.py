# -*- coding: utf-8 -*-
"""
Created on Tue Jun 23 23:45:12 2026
...
# --- Multi-Objective Rao Algorithm with Convergence Tracking ---
def multi_objective_rao(pop_size, num_variables, var_ranges, max_iter, archive_size, objective_functions,
    ...
    # Convergence tracking matching standard keys
    convergence_data = {
        "function_evals": [],
...
# Generate Reference Directions for SDTLZ2
...
# === Plot Function with Fixed Scale Scaling Layout ===
def plot_combined_metrics(all_convergence_data):
    ...
    # Compute mean values for each metric across runs
    ...
    # --- Min-Max Normalize Spacing so it fits cleanly alongside other metrics in [0,1] ---
    ...
    # === Reference Style: Linewidth=1.2, Markersize=2/2.5 ===
    ...
    # Force beautiful uniform scale limits
    plt.ylim(-0.05, 1.05)
    plt.grid(False)
