# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 11:44:37 2026
...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 15 21:33:29 2025
...
plt.title('Convergence of Performance Metrics for ZDT2 Problem', fontsize=16, fontweight='bold', pad=12)
...
plt.tight_layout()
plt.savefig('zdt2convg.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
...
plt.title('True vs. Obtained Pareto Front for ZDT2', fontsize=16, fontweight='bold', pad=12)
...
plt.grid(False)
plt.tight_layout()
plt.savefig('zdt2pf.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
print("Saved: Figure_Pareto_Front_Final.png successfully.")
