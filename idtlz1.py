...
def plot_combined_metrics(history):
    ...
    plt.show()
    plt.close()
    print("Saved: idtlz1convg.png successfully.")

def plot_pareto_front(true_pf, final_front):
    """3D Pareto Plot formatted for IDTLZ1 overlap view"""
    ...
    plt.title('True vs. Obtained Pareto Front for IDTLZ1', fontsize=16, fontweight='bold', pad=12)
    ...
    plt.tight_layout()
    plt.savefig('Idtlz1paretofront.png', dpi=300, bbox_inches='tight')
    plt.show()
    plt.close()
    print("Saved: Idtlz1paretofront.png successfully.")
...
if __name__ == "__main__":
    ...
    print("--- Starting 30-Run Optimization for IDTLZ1 ---")
